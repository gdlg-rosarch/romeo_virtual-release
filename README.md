## romeo_virtual (kinetic) - 0.2.3-0

The packages in the `romeo_virtual` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release romeo_virtual --track kinetic --rosdistro kinetic` on `Thu, 16 Nov 2017 15:18:29 -0000`
